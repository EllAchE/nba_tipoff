...
getAllOddsAndDisplayByEv(getFanduelToday=True, getMgm=True, getDk=True, getPointsBet=True, getUnibet=True, getBarstool=True, getFanduelTomorrow=True, includeOptimalPlayerSpread=True)
