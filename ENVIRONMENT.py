...
TS_PREDICTION_SUMMARIES_PATH = Path(os.path.abspath('Data/JSON/algorithms/trueskill/ts_prediction_summaries_{}_{}_{}_{}_{}_{}_{}.json'.format(
BASE_TS_MU, str(BASE_TS_SIGMA).replace('.', ''), str(BASE_TS_TAU).replace('.', ''), str(BASE_TS_BETA).replace('.', ''), MIN_TS_APPEARANCES, TS_TIPOFF_ODDS_THRESHOLD, SIGMA_DRIFT)))
...
GLICKO_PREDICTION_SUMMARIES_PATH = Path(os.path.abspath('Data/JSON/algorithms/glicko/glicko_prediction_summaries_{}_{}_{}_{}_{}_{}_{}.json'.format(
BASE_GLICKO_MU, str(BASE_GLICKO_SIGMA).replace('.', ''), BASE_GLICKO_PHI, str(BASE_GLICKO_TAU).replace('.', ''), MIN_GLICKO_APPEARANCES, GLICKO_TIPOFF_ODDS_THRESHOLD, PHI_DRIFT)))
...
ELO_PREDICTION_SUMMARIES_PATH = Path(os.path.abspath('Data/JSON/algorithms/elo/elo_prediction_summaries_{}_{}_{}_{}_{}.json'.format(
K_FACTOR, BASE_ELO, BASE_ELO_BETA, MIN_ELO_APPEARANCES, ELO_TIPOFF_ODDS_THRESHOLD)))
